 ...
 * @returns {string}
 */
export function generate_guard(prefix, suffix, x, line_ending) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.generate_guard(ptr0, len0, ptr1, len1, x, line_ending);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('guardgen_lib_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
